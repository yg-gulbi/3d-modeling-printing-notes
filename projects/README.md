...
| Mechanical design / dust signal assignment | `기계설계2*`, `너트볼트공차Test`, `미세먼지신호등`, `assemble/미세먼지*` | 작업 공간이 부족한 미세먼지 신호등을 더 쓰기 좋게 바꾸는 구조 설계 | [mechanical exercises](mechanical-design-exercises.md), [dust signal light](dust-signal-light.md) |
| Intelligent robot / structure models | `지능형로봇`, `지능형` | 몸체, 지지대, 센서 케이스, 의자형/로봇형 구조 | [intelligent robot](intelligent-robot.md) |
| Capstone design folder | `켑스톤디자인` | 별도 캡스톤 흐름으로 보관 | details to be organized later |
