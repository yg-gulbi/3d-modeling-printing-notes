...
These images are overview aids. Project-specific copies now live inside each `portfolio/<project>/images/previews/` folder.

![Model preview contact sheet](images/model-preview-contact-sheet.png)

| Preview | Project |
| --- | --- |
| `cyclone-classic.png` | [Cyclone systems](../cyclone-systems/) |
